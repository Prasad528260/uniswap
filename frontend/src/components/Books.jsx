          ...
          <div className="relative group">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="first" className="bg-slate-800">
                  Semester 1
                </option>
                <option value="second" className="bg-slate-800">
                  Semester 2
                </option>
                <option value="third" className="bg-slate-800">
                  Semester 3
                </option>
                <option value="fourth" className="bg-slate-800">
                  Semester 4
                </option>
                <option value="fifth" className="bg-slate-800">
                  Semester 5
                </option>
                <option value="sixth" className="bg-slate-800">
                  Semester 6
                </option>
                <option value="seventh" className="bg-slate-800">
                  Semester 7
                </option>
                <option value="eighth" className="bg-slate-800">
                  Semester 8
                </option>
              </select>
          ...
          <div className="relative group">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="notes" className="bg-slate-800">
                  Notes
                </option>
              </select>
              {/* Custom dropdown arrow */}
